...
Thank you for your interest in improving AutoTerminalScanClassic. This project
...
- Check the existing [issues](https://github.com/aoirint/AutoTerminalScanClassic/issues)
  and [pull requests](https://github.com/aoirint/AutoTerminalScanClassic/pulls)
...
- Use [GitHub Issues](https://github.com/aoirint/AutoTerminalScanClassic/issues)
...
- Before opening a new issue, check the existing
  [issues](https://github.com/aoirint/AutoTerminalScanClassic/issues) and
  [pull requests](https://github.com/aoirint/AutoTerminalScanClassic/pulls) to avoid
  duplicates.
